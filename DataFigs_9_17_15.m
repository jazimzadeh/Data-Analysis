...
clear;clc;clf;
cd('/Users/Julien/Google Drive/Hudspeth/Data/Orange Room/2015-09-17.01/Ear 1/Cell 1')
...
%% Overlaid plots - HB1
clf
annotation('textbox',[0.6 0.15 0.3 0.1],'String','9/17/15 HB1','FontSize',18)

for r = 2:5
    subplot_tight(2,2,r-1,[0.09 0.09])
...
saveas(gcf,strcat('Overlaid_9_17_15_HB1_mfig'));
saveas(gcf,strcat('Overlaid_9_17_15_HB1_e'),'epsc');

%% Overlaid plots - HB2
clf
annotation('textbox',[0.6 0.1 0.2 0.1],'String','9/17/15 HB2','FontSize',18)

for r = 6:14
    subplot_tight(5,2,r-5,[0.04 0.1])
    wavetrain           = logfile.data(r,8);
    set(0, 'DefaultAxesColorOrder', ametrine(wavetrain));
    for j = 2:wavetrain+1
        h1 = plot(t,struct_data(r).data_zeroed_scaled(:,2:j));
...
xlabel('Time (s)')
saveas(gcf,strcat('Overlaid_9_17_15_HB2_mfig'));
saveas(gcf,strcat('Overlaid_9_17_15_HB2_e'),'epsc');
