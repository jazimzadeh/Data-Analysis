...
cd('/Users/Julien/Google Drive/Hudspeth/Data/Orange Room/2014-03-31.01/Ear 1/Cell 1')
...
%% Recording 11 - for use as a figure showing vsteps and the resultant currents
Fs = 10000;         %sampling rate
T = 1/Fs;
L = length(struct_data.data11.data(:,20));
t = (0:L-1)*T;

subplot(4,1,1)
plot(t,struct_data.data11.data(:,2:11))
title('3/31/14 Record 11')
subplot(4,1,2:4)
plot(t,struct_data.data11.data(:,32:41))
