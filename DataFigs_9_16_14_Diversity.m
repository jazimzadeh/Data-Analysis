...
clear;clc;clf;
cd('/Users/Julien/Google Drive/Hudspeth/Data/Orange Room/2014-09-16.01/Ear 1/Cell 1')
...
r=3;     % Select the record numbers to plot
    ...
    %%
    r=10;     % Select the record numbers to plot
    ...
    %%
    r=15;     % Select the record numbers to plot
    ...
    saveas(gcf,strcat('9_16_14_Diversity',num2str(r),'.pdf'));
    saveas(gcf,strcat('9_16_14_Diversity_m',num2str(r),'fig'));
    saveas(gcf,strcat('9_16_14_Diversity_e',num2str(r),'.eps'),'epsc');
