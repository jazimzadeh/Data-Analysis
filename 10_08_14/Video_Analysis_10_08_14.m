clear;clc;
cd('/Users/Julien/Google Drive/Hudspeth/Data/High-Speed Videos/10_08_14/')

all_x = zeros(500,12);
for event_number = 1:12
...
offset = 0;
h = figure;
set(h,'DefaultAxesColorOrder', autumn(12))
for i = 2:12
...
xlabel('Time (ms)')
title('10/8/14 HB1 Videos, Events 2-12, bottom to top')
