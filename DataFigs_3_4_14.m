...
cd('/Users/Julien/Google Drive/Hudspeth/Data/Orange Room/2014-03-04.01/Ear 1/Cell 1')
...
for r = 1:13
    ...
    eval(['plot(t,struct_data.data' num2str(r) '.data(:,2:6)+1500,''k'')'])
    hold on
    eval(['plot(t,struct_data.data' num2str(r) '.data(:,12:16)+1000,''m'')'])
    hold on
    eval(['plot(t,struct_data.data' num2str(r) '.data(:,17:21))'])
